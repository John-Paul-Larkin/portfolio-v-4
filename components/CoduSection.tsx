...
export default function CoduSection() {
  return (
    <div
     ...
     s80:gap-[2rem] s80:p-[2rem] mt-[1rem] grid  grid-cols-[repeat(8,1fr)]  grid-rows-1 
      gap-4 overflow-hidden rounded-[2rem] bg-overall-bg p-[1rem]"
    >
      <motion.div
        ...
        className=" max-w-container-width... s80:col-span-5 s100:h-[30rem] col-span-full grid h-[48rem] overflow-hidden rounded-[1rem]"
      >
        <div className="s100:flex-row relative z-10 flex h-full  flex-col overflow-hidden rounded-[1rem] bg-space">
          ...
          <div className="flex flex-col items-center">
            <div className="s100:w-[20rem] relative h-[7rem] w-[80%]">
              <Image
                src="/codu.svg"
                fill={true}
                alt="codu logo"
            ...
            <div className="flex justify-center">
              <motion.div
                className="s100:h-[20rem] absolute bottom-[-7rem] z-0 aspect-square h-[18rem]"
                initial={{ rotate: 0, x: "50px", y: 0 }}
                whileInView={{ rotate: 90, x: "-50px", y: "50px" }}
                viewport={{ once: true, margin: "0px 0px -100px 0px" }}
                transition={{
                  duration: 10,
                  repeat: Infinity,
