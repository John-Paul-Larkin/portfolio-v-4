              ...
              {/* <div className="hidden... relative top-[-50%] z-30 grid w-full grid-cols-3 grid-rows-1 gap-[1rem] p-[1rem] text-[18px] text-white">
                ...
                <div className="overflow-hidden... pt-[1rem]...">
                  <motion.div
                    ...
                    className="flex h-[2rem] items-center rounded-md bg-orange-700 pr-[1rem] shadow-md shadow-slate-600 "
                  >
                    <p className="flex-grow pl-[2rem]">JavaScript</p>
                    <div className="relative top-[-1rem] w-[2rem]">
                      <svg
                        viewBox="0 0 128 128"
                        className="absolute shadow-md shadow-slate-600"
                      >
                        <path
                          fill="#F0DB4F"
